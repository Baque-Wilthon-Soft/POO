...
namespace Miproyecto1.Presentación
{
    public partial class CUPersonal : UserControl
    {
        ...
        {
            DialogResult cuadrodialogo = MessageBox.Show("Está seguro que desea eliminar el personal?"
            ...
            {
                MessageBox.Show("El usuario canceló la eliminacion");
            }
        }
